    ...
    def _setup_routes(self):
        ...
        def batch_analyze():
            try:
                ...
                return jsonify({
                    "success": True, "total_count": len(stocks),
                    "success_count": success_count, "failed_count": len(stocks) - success_count,
        ...
        def add_monitor_rule():
            try:
                ...
                monitoring_system.add_alert_rule(
                    data['rule_id'], data['ticker'], data['rule_type'],
                    data['condition'], data['threshold'], data['message']
                )
